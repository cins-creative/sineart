-- =============================================================================
-- hv_he_thong_bai_tap <-> ql_mon_hoc (many-to-many)
-- Run in Supabase SQL Editor.
--
-- Junction: hv_he_thong_bai_tap_mon_hoc (bai_tap_id, mon_hoc_id)
-- Keeps hv_he_thong_bai_tap.mon_hoc in sync = MIN(mon_hoc_id) for legacy queries.
-- =============================================================================
...
COMMENT ON TABLE public.hv_he_thong_bai_tap_mon_hoc IS 'Many-to-many: exercise <-> subject (mon hoc).';
...
CREATE TRIGGER trg_sync_htbt_mon_after_junction
  ...
  FOR EACH ROW
  EXECUTE FUNCTION public.sync_htbt_primary_mon_hoc();
