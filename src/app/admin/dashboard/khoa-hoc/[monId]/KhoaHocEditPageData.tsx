...
export default async function KhoaHocEditPageData({ params }: Props) {
  ...
  const { data, error } = await supabase
    .from("ql_mon_hoc")
    .select("id, ten_mon_hoc, thumbnail, loai_khoa_hoc, thu_tu_hien_thi, is_featured, hinh_thuc, si_so")
    .eq("id", id)
    .maybeSingle();
