...
export default async function ReportMktPageData() {
          ...
          {isPerm ? (
            <div className="mt-3 space-y-3 text-xs leading-relaxed text-red-900/90">
              <p>
                ...
                cách sau (cùng project với biến{" "}
                <code className="rounded bg-red-100/80 px-1">NEXT_PUBLIC_SUPABASE_URL</code> trong Vercel).
              </p>
