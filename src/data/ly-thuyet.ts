...
export const LY_THUYET_LIST: LyThuyet[] = [
  ...
  },
  {
    ...
    so_thu_tu: 10,
    mo_ta:
      "Hình chiếu song song — đường thẳng song song vẫn song song; isometric & kiến trúc kỹ thuật không dùng điểm tụ cổ điển.",
  ...
  },
  {
    ...
    so_thu_tu: 11,
    mo_ta:
      "Phối cảnh cong góc rộng — mép lõm/bụng phình, đường chân trời cong; minh họa và ảnh ống kính siêu rộng.",
  ...
  },
  {
    ...
    so_thu_tu: 12,
    mo_ta:
      "Toàn cảnh 360° — equirectangular, VR và quy tắc dựng khi ‘gập’ không gian quanh người xem.",
  ...
  },
  {
    ...
    so_thu_tu: 35,
    mo_ta:
      "Chữ như hình: font, hierarchy, khoảng dòng, độ tương phản và bố cục chữ trong poster, sách và portfolio.",
