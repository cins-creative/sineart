...
const KIEN_THUC_STATIC_SEGMENTS = [
  ...
  "giai-phau-ban-chan",
  "giai-phau-ban-tay",
  "giai-phau-chan-dung-nguoi",
  "giai-phau-cho-hoa-si",
  "he-thong-mau-munsell",
  "khong-gian-mau",
  "ly-thuyet-hoa-sac",
  "ly-thuyet-phoi-canh",
  "ly-thuyet-vat-lieu",
  "ly-thuyet-vat-lieu-pbr",
  "mau-sac-qua-thiet-bi-dien-tu",
  "mo-hinh-cong-tru-mau",
  "nghe-thuat-chu-typography",
  "nguyen-ly-thi-giac",
  "phoi-canh-khi-quyen",
  "phoi-canh-mat-ca",
  "phoi-canh-panorama-360",
  "phoi-canh-song-song",
  "phuong-phap-ve-cau-truc",
  "phuong-phap-ve-force",
  "phuong-phap-ve-gioi-han",
  "phuong-phap-ky-hoa",
  "phuong-phap-ve-silhouette",
  "shading-la-gi",
  "thuoc-tinh-mau-sac",
  "ti-le-co-the-nguoi",
] as const;
